...
import (
	...
	"github.com/konikvranik/prometheus-json-exporter"
)
...
func TestWalkJSON(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			expected: []kvPair{
				kvPair{key: "x_y__0", value: 1},
				kvPair{key: "x_y__1", value: 2},
				kvPair{key: "x_y__2", value: 3},
			},
		},
		{
